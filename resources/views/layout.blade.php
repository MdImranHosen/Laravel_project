...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{ URL::to('/') }}"><span> 4D N.S </span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="{{ URL::to('public/backend/img/avatar.jpg') }}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Łukasz Holeczek
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{ URL::to('public/backend/img/avatar2.jpg') }}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Megan Abott
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{ URL::to('public/backend/img/avatar3.jpg') }}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Kate Ross
										     </span>
								...
								<li>
                                    <a href="#">
										<span class="avatar"><img src="{{ URL::to('public/backend/img/avatar4.jpg') }}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{ URL::to('public/backend/img/avatar5.jpg') }}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Jane Sanders
										     </span>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="{{ URL::to('add-contact') }}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Add Contact</span></a></li>	
						<li><a href="{{ route('all.contact') }}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Contact</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2018 <a href="http://bootstrapmaster.com/" alt="Bootstrap Themes">Md. Imran Hosen</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="#" alt="Bootstrap Admin Templates">4D Vision</a></span>
		</p>
	...
	<!-- start: JavaScript-->
		...
		<script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.0.1/js/toastr.js') }}" type="text/javascript"></script>
